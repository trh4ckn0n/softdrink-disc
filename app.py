...
if page == "Présentation":
    ...
    <div class='intro-wrapper'>
        <div class='intro'>Boissons énergétiques.</div>
        <div class='intro'>la célèbre boisson au taureau.</div>
        <div class='intro'>et son équivalent PALESTINE drink.</div>
    </div>
""", unsafe_allow_html=True)
    ...
    if st.button("Envoyer commande"):
        if nom and choice and contact:
            ...
            msg = (
                f"Nouvelle commande de {nom} pour **{quantite}x {choice}** avec code promo:{promo_code}"
